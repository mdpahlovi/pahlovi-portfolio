...
const Button = ({ children, to }) => {
    return (
        <Link
            to={to}
            className="relative inline-flex items-center justify-start py-2.5 pl-4 pr-12 overflow-hidden font-semibold text-base-content transition-all duration-150 ease-in-out rounded hover:pl-10 hover:pr-6 bg-base-content/5 group"
        >
