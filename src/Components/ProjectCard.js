...
const ProjectCard = ({ project }) => {
    ...
    const { name, category, thumbnail } = project;

    return (
        <div className="group relative block bg-black">
            <img src={thumbnail} className="absolute inset-0 h-full w-full object-cover transition-opacity opacity-90 group-hover:opacity-80" alt="" />
